...
Input::Input(const std::shared_ptr<Window> window)
{
  ...
  forwardKeyPressed = backKeyPressed = leftKeyPressed = rightKeyPressed = upKeyPressed = downKeyPressed =
    crouchKeyPressed = flyKeyPressed = showCursorKeyPressed = showResultsWindowKeyPressed = leftMouseButtonPressed =
      rightMouseButtonPressed = false;
  showControlsWindowKeyPressed = showBenchmarkWindowKeyPressed = showLightEditorKeyPressed = showGraphsKeyPressed =
    true;
}
