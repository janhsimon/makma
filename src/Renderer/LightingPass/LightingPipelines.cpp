...
vk::PipelineLayout* LightingPipelines::createPipelineLayout(const std::shared_ptr<Context> context,
...
vk::Pipeline* LightingPipelines::createPipelineNoShadowMaps(const std::shared_ptr<Window> window,
                                                            ...
                                                            const vk::PipelineLayout* pipelineLayout)
{
  ...
  // specializationConstants.push_back(vk::SpecializationMapEntry().setConstantID(0).setOffset(offsetof(SpecializationData,
  // shadowMapCascadeCount)).setSize(sizeof(specializationData.shadowMapCascadeCount)));
  // specializationConstants.push_back(vk::SpecializationMapEntry().setConstantID(1).setOffset(offsetof(SpecializationData,
  // shadowBias)).setSize(sizeof(specializationData.shadowBias)));
  // specializationConstants.push_back(vk::SpecializationMapEntry().setConstantID(2).setOffset(offsetof(SpecializationData,
  // shadowFilterRange)).setSize(sizeof(specializationData.shadowFilterRange)));
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(0)
                                      .setOffset(offsetof(SpecializationData, bloomThreshold))
                                      .setSize(sizeof(specializationData.bloomThreshold)));
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(1)
                                      .setOffset(offsetof(SpecializationData, volumetricIntensity))
                                      .setSize(sizeof(specializationData.volumetricIntensity)));
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(2)
                                      .setOffset(offsetof(SpecializationData, volumetricSteps))
                                      .setSize(sizeof(specializationData.volumetricSteps)));
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(3)
                                      .setOffset(offsetof(SpecializationData, volumetricScattering))
                                      .setSize(sizeof(specializationData.volumetricScattering)));
  ...
  auto colorBlendAttachmentState = vk::PipelineColorBlendAttachmentState().setColorWriteMask(
...
vk::Pipeline* LightingPipelines::createPipelineWithShadowMaps(const std::shared_ptr<Window> window,
                                                              const std::shared_ptr<Context> context,
                                                              const vk::RenderPass* renderPass,
                                                              const vk::PipelineLayout* pipelineLayout)
{
  ...
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(0)
                                      .setOffset(offsetof(SpecializationData, shadowMapCascadeCount))
                                      .setSize(sizeof(specializationData.shadowMapCascadeCount)));
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(1)
                                      .setOffset(offsetof(SpecializationData, shadowBias))
                                      .setSize(sizeof(specializationData.shadowBias)));
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(2)
                                      .setOffset(offsetof(SpecializationData, shadowFilterRange))
                                      .setSize(sizeof(specializationData.shadowFilterRange)));
  specializationConstants.push_back(vk::SpecializationMapEntry()
                                      .setConstantID(3)
                                      .setOffset(offsetof(SpecializationData, bloomThreshold))
                                      .setSize(sizeof(specializationData.bloomThreshold)));
...
LightingPipelines::LightingPipelines(const std::shared_ptr<Window> window,
                                     const std::shared_ptr<Context> context,
                                     ...
                                     const vk::RenderPass* renderPass)
{
  ...
  pipelineLayoutNoShadowMaps = std::unique_ptr<vk::PipelineLayout, decltype(pipelineLayoutDeleter)>(
    createPipelineLayout(context, setLayoutsNoShadowMaps), pipelineLayoutDeleter);
  pipelineNoShadowMaps = std::unique_ptr<vk::Pipeline, decltype(pipelineDeleter)>(
    createPipelineNoShadowMaps(window, context, renderPass, pipelineLayoutNoShadowMaps.get()), pipelineDeleter);

  pipelineLayoutWithShadowMaps = std::unique_ptr<vk::PipelineLayout, decltype(pipelineLayoutDeleter)>(
    createPipelineLayout(context, setLayoutsWithShadowMaps), pipelineLayoutDeleter);
  pipelineWithShadowMaps = std::unique_ptr<vk::Pipeline, decltype(pipelineDeleter)>(
    createPipelineWithShadowMaps(window, context, renderPass, pipelineLayoutWithShadowMaps.get()), pipelineDeleter);
}
