...
private:
	...
	static vk::SwapchainKHR *createSwapchain(const Window *window, const std::shared_ptr<Context> context);
	...
	static std::vector<vk::Framebuffer> *createFramebuffers(const Window *window, const std::shared_ptr<Context> context, const std::shared_ptr<Pipeline> pipeline, const std::vector<vk::ImageView> *imageViews);
	...
	static std::vector<vk::CommandBuffer> *createCommandBuffers(const Window *window, const std::shared_ptr<Context> context, const std::shared_ptr<Pipeline> pipeline, const std::shared_ptr<Buffers> buffers, const std::vector<vk::Framebuffer> *framebuffers);
	std::unique_ptr<std::vector<vk::CommandBuffer>> commandBuffers;

public:
	Swapchain(const Window *window, const std::shared_ptr<Context> context);

	void finalize(const Window *window, const std::shared_ptr<Pipeline> pipeline, const std::shared_ptr<Buffers> buffers);
