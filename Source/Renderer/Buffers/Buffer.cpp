...
vk::Buffer *Buffer::createBuffer(const std::shared_ptr<Context> context, vk::DeviceSize size, vk::BufferUsageFlags usage)
{
...
vk::DeviceMemory *Buffer::createMemory(const std::shared_ptr<Context> context, const vk::Buffer *buffer, vk::DeviceSize size, vk::MemoryPropertyFlags memoryPropertyFlags)
{
...
Buffer::Buffer(const std::shared_ptr<Context> context, vk::BufferUsageFlags usage, vk::DeviceSize size, vk::MemoryPropertyFlags memoryPropertyFlags)
{
