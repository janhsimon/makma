...
private:
	...
	std::unique_ptr<vk::Semaphore, decltype(semaphoreDeleter)> imageAvailableSemaphore, shadowPassDoneSemaphore, geometryPassDoneSemaphore, lightingPassDoneSemaphore, presentDoneSemaphore;
