...
private:
	...
	std::unique_ptr<vk::Semaphore, decltype(semaphoreDeleter)> imageAvailableSemaphore, geometryPassDoneSemaphore, lightingPassDoneSemaphore, presentDoneSemaphore;
