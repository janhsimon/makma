...
void Material::loadDefaultTextures(const std::shared_ptr<Context> context)
{
	...
	defaultBlackRTexture = std::make_shared<Texture>(context, "Textures\\DefaultBlack.png", vk::Format::eR8Unorm);
	defaultNormalRGBTexture = std::make_shared<Texture>(context, "Textures\\DefaultNormal.png", vk::Format::eR8G8B8A8Unorm);
}
